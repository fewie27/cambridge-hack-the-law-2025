...
class DefaultApi {
  ...
  Future<Response<AnalysisResponse>> addCase({ 
    required AddCaseRequest addCaseRequest,
    ...
    try {
      const _type = FullType(AddCaseRequest);
      _bodyData = _serializers.serialize(addCaseRequest, specifiedType: _type);
  ...
  Future<Response<GetHealth200Response>> getHealth({ 
    ...
    GetHealth200Response? _responseData;
    ...
    return Response<GetHealth200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
